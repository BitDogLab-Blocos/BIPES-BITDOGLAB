...
assert.match(workspaceHints, /Siga as setas da imagem/);
assert.match(workspaceHints, /Seta vermelha.*\+3V3/);
assert.match(workspaceHints, /Seta azul.*DADOS/);
assert.match(workspaceHints, /Seta preta.*GND/);
assert.match(workspaceHints, /garra jacaré/);
assert.match(workspaceHints, /V7:<\/strong> o fio de DADOS só pode usar as Conexões 0 e 1/);
assert.match(workspaceHints, /V6:<\/strong> o fio de DADOS pode usar as Conexões 0, 1, 2 ou 3/);
assert.match(workspaceHints, /peça ao professor para conferir os fios/);
...
assert.match(workspaceHints, /Prenda a ponta macho na garra jacaré/);
