...
assert.match(workspaceHints, /Pinos do módulo DHT11/);
assert.match(workspaceHints, /S \(pino da esquerda\).*positivo \/ 3V3/);
assert.match(workspaceHints, /Pino do meio.*DADOS/);
assert.match(workspaceHints, /- \(pino da direita\).*negativo \/ GND/);
assert.match(workspaceHints, /garra jacaré/);
assert.match(workspaceHints, /V7:<\/strong> use somente as Conexões 0 e 1/);
assert.match(workspaceHints, /V6:<\/strong> as Conexões 0, 1, 2 e 3/);
...
assert.match(workspaceHints, /ponta macho presa à garra jacaré/);
